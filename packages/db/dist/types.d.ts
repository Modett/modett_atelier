...
import { users, admins, adminInvites, sessions, wishlists, savedAddresses, savedPaymentMethods } from './schema/iam.schema';
import { categories, products, productPrices, productImages, productRelations, productStylingGuides, bestsellerList, banners } from './schema/catalog.schema';
import { productVariants, variantStock, inventoryUnits, inventoryMovements, inventoryReconciliationLog } from './schema/inventory.schema';
...
import { promoCodes, ordersTable, promoRedemptions, orderItems, orderAddresses, orderContacts, orderEvents, orderUnitAllocations } from './schema/orders.schema';
import { paymentIntents, paymentTransactions } from './schema/payments.schema';
import { returnRequests, returnRequestItems, returnEvents } from './schema/returns.schema';
import { reviewRequestTokens, reviewsTable, reviewMedia, reviewFlags } from './schema/reviews.schema';
import { loyaltyAccounts, loyaltyLedger, loyaltyRules, loyaltyGrants } from './schema/loyalty.schema';
import { inboxMessages, notificationPreferences, notificationOutbox, emailDeliveryLog, backInStockSubscriptions, priceDropSubscriptions, campaigns, campaignDeliveries, notifyMeEvents } from './schema/messaging.schema';
...
export type ProductStylingGuideInsert = InferInsertModel<typeof productStylingGuides>;
...
export type InventoryReconciliationLog = InferSelectModel<typeof inventoryReconciliationLog>;
export type InventoryReconciliationLogInsert = InferInsertModel<typeof inventoryReconciliationLog>;
...
export type OrderUnitAllocationInsert = InferInsertModel<typeof orderUnitAllocations>;
...
export type PaymentTransactionInsert = InferInsertModel<typeof paymentTransactions>;
...
export type ReviewRequestTokenInsert = InferInsertModel<typeof reviewRequestTokens>;
...
export type BackInStockSubscriptionInsert = InferInsertModel<typeof backInStockSubscriptions>;
export type PriceDropSubscription = InferSelectModel<typeof priceDropSubscriptions>;
export type PriceDropSubscriptionInsert = InferInsertModel<typeof priceDropSubscriptions>;
...
export type AnalyticsAggregateInsert = InferInsertModel<typeof analyticsAggregates>;
