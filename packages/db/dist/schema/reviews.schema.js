 ...
 */
import { pgSchema, uuid, text, boolean, integer, timestamp, smallint, } from 'drizzle-orm/pg-core';
...
export const reviewFlags = reviews.table('review_flags', {
    ...
    resolved_by_admin_id: uuid('resolved_by_admin_id').references(() => admins.id, { onDelete: 'set null' }),
});
